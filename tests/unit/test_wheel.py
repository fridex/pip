...
class TestInstallUnpackedWheel:
    ...
    def test_std_install_with_provenance_url(self, data: TestData, tmpdir: Path) -> None:
        ...
        provenance_url_path = os.path.join(self.dest_dist_info, PROVENANCE_URL_METADATA_NAME)
